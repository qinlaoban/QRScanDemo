...
/** 遮罩层 */
@property (nonatomic, strong) QRMaskView * maskView;
/** 返回按钮 */
 ...
 */
- (void)addUI{
    self.maskView = [[QRMaskView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
    ...
    self.backHintLabel.textColor = QRWhite;
    ...
    self.flashlightHintLabel.textColor = QRWhite;
...
- (void)flashlightAction:(UIButton *)sender{
    ...
    if (sender.selected) {
        ...
        self.flashlightHintLabel.textColor = QRColor(133, 235, 0, 1);
